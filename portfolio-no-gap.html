...
<head>
    ...
    <!-- Title  -->
    <title>Digimax - SEO & Digital Marketing Agency HTML Template | Portfolio Grid No Gap</title>
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-content text-center">
                            ...
                            <ol class="breadcrumb d-flex justify-content-center">
                                ...
                                <li class="breadcrumb-item text-white active">Portfolio Grid No Gap</li>
                            </ol>
                        </div>
                    </div>
                </div>

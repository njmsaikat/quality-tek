...
<head>
    ...
    <!-- Title  -->
    <title>Digimax - SEO & Digital Marketing Agency HTML Template | Homepage-2 One Page</title>
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-12 col-md-9">
                        ...
                        <div class="video-content">
                            ...
                            <img class="video-thumb" src="assets/img/bg/video_bg.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <div class="single-case-studies">
                            ...
                            <a href="assets/img/case_studies/case_studies_2/thumb_1.jpg" data-fancybox="images" class="case-studies-overlay">
                                <!-- Overlay Text -->
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <div class="single-case-studies">
                            ...
                            <!-- Case Studies Overlay -->
                            <a href="assets/img/case_studies/case_studies_2/thumb_2.jpg" data-fancybox="images" class="case-studies-overlay">
                                <!-- Overlay Text -->
                                <span class="overlay-text text-center p-3">
                                    <i class="fas fa-search-plus fa-2x text-white"></i>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <div class="single-case-studies">
                            ...
                            <!-- Case Studies Overlay -->
                            <a href="assets/img/case_studies/case_studies_2/thumb_3.jpg" data-fancybox="images" class="case-studies-overlay">
                                <!-- Overlay Text -->
                                <span class="overlay-text text-center p-3">
                                    <i class="fas fa-search-plus fa-2x text-white"></i>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <div class="single-case-studies">
                            ...
                            <!-- Case Studies Overlay -->
                            <a href="assets/img/case_studies/case_studies_2/thumb_4.jpg" data-fancybox="images" class="case-studies-overlay">
                                <!-- Overlay Text -->
                                <span class="overlay-text text-center p-3">
                                    <i class="fas fa-search-plus fa-2x text-white"></i>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <div class="single-case-studies">
                            ...
                            <!-- Case Studies Overlay -->
                            <a href="assets/img/case_studies/case_studies_2/thumb_5.jpg" data-fancybox="images" class="case-studies-overlay">
                                <!-- Overlay Text -->
                                <span class="overlay-text text-center p-3">
                                    <i class="fas fa-search-plus fa-2x text-white"></i>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <div class="single-case-studies">
                            ...
                            <!-- Case Studies Overlay -->
                            <a href="assets/img/case_studies/case_studies_2/thumb_6.jpg" data-fancybox="images" class="case-studies-overlay">
                                <!-- Overlay Text -->
                                <span class="overlay-text text-center p-3">
                                    <i class="fas fa-search-plus fa-2x text-white"></i>
